...
insert into jobs (id, title, description, publish_date, close_date, committee_chair_id) values
    (2, 'Tenure-Track Faculty Position (Start Fall 2016)', 'Description ...', current_timestamp, '8/7/2015', 3);
insert into jobs (id, title, description, publish_date, close_date, committee_chair_id) values
    (3, 'New Job (Fall 2016)', 'Job description....', current_timestamp, '8/21/2015', 3);
